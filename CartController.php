...
Log::emergency($request);
        ...
        if (Auth::check()) {
            ...
            if ($validator->fails()) {
                ...
                if ( $products[0]->variant_status == 1 &&  $products[0]->color_status == 0) {
                    $size_data = DB::table('current_product_sizes')->where('outlet_uid', $request->outlet_uid)->where('product_id', $request->product_id)->get();
